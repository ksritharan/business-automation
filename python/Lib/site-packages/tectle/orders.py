...
def update_orders_helper(limit, offset):
    ...
    if 'DEBUG' not in session:
        url = 'https://openapi.etsy.com/v2/shops/21834267/receipts/open?limit=%s&offset=%s' %(limit, offset)
    else:
...
def get_product_data(sku, package_classes):
    ...
    if category == 'P':
        if data['design_id'] == 1:
            ...
            data['name'] = 'Iceberg'
        elif data['design_id'] == 6:
            data['name'] = 'Snowball'
        elif data['design_id'] == 7:
            data['name'] = 'Wildflower'
        elif data['design_id'] == 8:
            data['name'] = 'Sydney'
        else:
            logger.error(sku)
    ...
    if category == 'A':
        ...
        if data['size'] < 3:
            data['package_class_id'] = package_classes['Small']['id']
        elif data['size'] < 5 and data['name'] == 'Wildflower':
            data['package_class_id'] = package_classes['Wildflower']['id']
        elif data['size'] < 5:
